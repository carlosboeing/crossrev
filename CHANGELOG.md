...
- `revloop auth login` — registers a GitHub App through the [App Manifest flow](https://docs.github.com/en/apps/sharing-github-apps/registering-a-github-app-from-a-manifest), prefilling the three permissions and disabling the webhook so the form offers nothing to get wrong. The temporary code is pasted back rather than caught by a local listener.
