...
// skip a RETURN one (lib/auth.sh:1020-1027 and :1041-1045). None of that is
...
func (c *Commands) Refresh(ctx context.Context, req RefreshRequest) error {
	...
	// below unavailable, and nothing else (lib/auth.sh:1030).
...
// SetRepoSecret writes a repository secret (lib/auth.sh:1060).
...
// secret set …` (lib/auth.sh:1056 and :1036).
//
